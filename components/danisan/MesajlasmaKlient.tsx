...
const POLL_MS = 8000; // 8 saniyede bir yeni mesaj kontrolü

export default function MesajlasmaKlient({
  konusmaId,
  konusmaTip,
  benimId,
  karsiTaraf,
      ...
      <div className="shrink-0 border-b border-[#D4E4D8] dark:border-[#333] bg-[#F5F7F5] dark:bg-[#111] px-4 py-3 flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="text-[10px] text-[#4A4D4A]">
            ...
            {karsiTaraf.telefon && ` · ${karsiTaraf.telefon}`}
          </div>
        </div>
        <Link
          href={`/danisan/danisanlar/${karsiTaraf.id}`}
      ...
      <div className="shrink-0 border-t border-[#D4E4D8] dark:border-[#333] bg-white dark:bg-[#1a1a1a] px-4 py-3">
        ...
        <div className="flex gap-2 items-end">
          ...
          <button
            ...
            className="bg-[#A6DE9B] text-[#325343] text-[11px] font-bold uppercase tracking-[0.5px] px-4 py-2 h-[56px] hover:opacity-90 hover:scale-[1.01] transition-all duration-100 disabled:opacity-40"
          >
            {gonderiliyor ? "..." : "Gönder"}
          </button>
        </div>
