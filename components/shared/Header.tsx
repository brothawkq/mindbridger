          ...
          {NAV_LINKS.map(({ href, label }) => {
            ...
            return (
              <Link
                ...
                onMouseEnter={(e) => {
                  if (!active) (e.currentTarget as HTMLAnchorElement).style.color = "#F5F7F5";
                }}
                onMouseLeave={(e) => {
                  if (!active) (e.currentTarget as HTMLAnchorElement).style.color = navColor;
                }}
              >
                {label}
              </Link>
          ...
          {loading ? (
            <div
              style={{
                width: 80,
                height: 32,
                background: "rgba(245,247,245,0.15)",
                borderRadius: 100,
                opacity: 0.5,
              }}
            />
            ...
            <div style={{ position: "relative" }} ref={menuRef}>
              <button
                ...
                onMouseEnter={(e) => {
                  (e.currentTarget as HTMLButtonElement).style.backgroundColor = "rgba(245,247,245,0.08)";
                }}
                onMouseLeave={(e) => {
                ...
                {menuOpen && (
                  ...
                  >
                    <Link
                      ...
                      style={menuItemStyle}
                      onMouseEnter={(e) => {
                        (e.currentTarget as HTMLAnchorElement).style.backgroundColor = "rgba(166,222,155,0.1)";
                      }}
                      onMouseLeave={(e) => {
                    ...
                    <button
                      ...
                      onMouseEnter={(e) => {
                        (e.currentTarget as HTMLButtonElement).style.backgroundColor = "rgba(166,222,155,0.1)";
                      }}
                      onMouseLeave={(e) => {
                        (e.currentTarget as HTMLButtonElement).style.backgroundColor = "transparent";
                      }}
            ...
            <div style={{ display: "flex", gap: 8 }}>
              ...
              <Link
                ...
                onMouseEnter={(e) => {
                  (e.currentTarget as HTMLAnchorElement).style.backgroundColor = "#8ED485";
                }}
                onMouseLeave={(e) => {
                  (e.currentTarget as HTMLAnchorElement).style.backgroundColor = "#A6DE9B";
                }}
              >
                Kayıt Ol
              </Link>
